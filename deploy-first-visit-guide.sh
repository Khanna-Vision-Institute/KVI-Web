#!/bin/bash
# Deploy first visit guide page to production KVI Node server.
set -e
if [[ -z "${SSH_KEY:-}" ]]; then
  for candidate in \
...
echo "Deploying first-visit-guide.html to ${SSH_HOST}..."
scp -i "${SSH_KEY}" -o StrictHostKeyChecking=accept-new \
  "${SCRIPT_DIR}/patients/your-journey/first-visit-guide.html" \
  "${SSH_USER}@${SSH_HOST}:${REMOTE_BASE}/patients/your-journey/"
...
echo "Done. https://khannainstitute.com/patients/your-journey/first-visit-guide/"
