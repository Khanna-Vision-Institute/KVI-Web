#!/bin/bash
# Deploy Dr. Khanna media page to production KVI Node server.
set -e
if [[ -z "${SSH_KEY:-}" ]]; then
  for candidate in \
...
echo "Deploying media.html to ${SSH_HOST}..."
...
echo "Done. https://khannainstitute.com/about/dr-khanna/media/"
