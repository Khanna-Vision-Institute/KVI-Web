#!/bin/bash
# Deploy gallery page to production KVI Node server.
set -e
if [[ -z "${SSH_KEY:-}" ]]; then
  for candidate in \
...
echo "Deploying gallery.html to ${SSH_HOST}..."
scp -i "${SSH_KEY}" -o StrictHostKeyChecking=accept-new \
  "${SCRIPT_DIR}/about/why-choose-us/gallery.html" \
...
echo "Done. https://khannainstitute.com/about/why-choose-us/gallery/"
